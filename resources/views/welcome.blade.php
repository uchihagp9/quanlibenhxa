...
<head>
    ...
    <title>Hệ thống quản lý bệnh xá | Dashboard</title>
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="block m-t-xs font-bold">Nguyễn Văn Âu</span>
                                <span class="text-muted text-xs block">Quản trị viên <b class="caret"></b></span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="dropdown-item" href="profile.html">Profile</a></li>
                                <li><a class="dropdown-item" href="contacts.html">Liên hệ</a></li>
                                <li><a class="dropdown-item" href="mailbox.html">Hộp thư điện thử</a></li>
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" action="search_results.html">
                <div class="form-group">
                    <input type="text" placeholder="Nhập từ cần tìm..." class="form-control" name="top-search" id="top-search">
                </div>
            </form>
        </div>
            <ul class="nav navbar-top-links navbar-right">
                <li style="padding: 20px">
                    <span class="m-r-sm text-muted welcome-message">Chào mừng quản trị viên: Admin</span>
                </li>
                <li class="dropdown">
                ...
                <div class="row  border-bottom white-bg dashboard-header">
                    ...
                    <div class="col-md-3">
                        <h2>Bệnh xá sư đoàn</h2>
                        <small>Bạn có 42 tin nhắn và 6 thông báo.</small>
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('Giao diện Quản trị viên', 'Chào mừng đến bệnh xá sư đoàn 330');
